...
/**
 * Clase que representa la factura sustituida
 * @package: verifactuPHP\Models
 * @see: https://verifactuapi.es/ 
 */
class FacturaSustituida 
{
     ...
     * @return array Array con los datos de la factura sustituida
     */
    ...
    /**
     * Crea y retorna un objeto FacturaSustituida vacío
     * @return FacturaSustituida Objeto FacturaSustituida con valores por defecto
     */
    public static function empty(): FacturaSustituida {
        return new FacturaSustituida([
            'IDEmisorFactura' => '',
            'numSerieFactura' => '',
